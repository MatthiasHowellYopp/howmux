...
The hotkey toggle feature allows you to quickly switch between console mode and planning mode using a keyboard shortcut while working in Howmux.

## Quick Start

Press **Ctrl+Alt+P** (or **Ctrl+Option+P** on macOS) to toggle between modes:

- **Console Mode** → **Planning Mode**: Switch from the main Howmux interface to interactive planning
