...
|----------|---------------|----------------------|
| CPU | 1.0 core (1,000,000 μs) | `HOWMUX_EVAL_CPU_QUOTA` |
| Memory | 512MB | `HOWMUX_EVAL_MEMORY_LIMIT` |
...
HOWMUX_EVAL_CPU_QUOTA=500000 \
HOWMUX_EVAL_MEMORY_LIMIT=268435456 \
howmux eval --sandbox architect
...
HOWMUX_EVAL_MEMORY_LIMIT=1073741824 howmux eval --sandbox
```
...
HOWMUX_EVAL_NETWORK_MODE=bridge howmux eval --sandbox
```
