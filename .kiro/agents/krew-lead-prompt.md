...
- Do NOT run `.howmux/scripts/worktree-merge.sh` — the PR workflow handles merging
...
The pattern is: `.howmux/artifacts/<agent-name>-<issue-number>.md`

Examples for issue 42:
- Architect: `.howmux/artifacts/architect-42.md`
- Builder: `.howmux/artifacts/builder-42.md`
- Validator: `.howmux/artifacts/validator-42.md`
- Documenter: `.howmux/artifacts/documenter-42.md`

When a subagent returns an empty response, check for its sentinel file before retrying:
1. Check: `test -f .howmux/artifacts/<agent-name>-<issue-number>.md`
